...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Section wristband="guys" data={guysData} productUrl="/" isLoading={isLoading} color="rgb(96, 91, 163)" heading="Guy's Campus Wristband" events={guysEvents}>
      ...
      <Section wristband="strand" data={strandData} isLoading={isLoading} color="rgb(245, 160, 0)" heading="Strand Campus Guy's Campus Wristband" events={strandEvents}>
