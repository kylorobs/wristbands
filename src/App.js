...
function App() {
  ...
  return (
    <div className="App">
      <Landing />
      <Section isLoading={isLoading} color="rgb(96, 91, 163)" heading="Guy's Campus Wristband" events={guysEvents}>
      ...
      <Section isLoading={isLoading} color="rgb(237, 124, 121)" heading="Freshers Guy's Campus Wristband" events={freshersEvents}>
